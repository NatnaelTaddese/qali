...
export function WorkspaceSkeleton() {
  return (
    ...
    >
      ...
      >
        <div className="flex items-center gap-1 rounded-[28px] border border-[#ccc] bg-white px-2 py-1.5 shadow-lg backdrop-blur dark:border-border dark:bg-popover/90">
